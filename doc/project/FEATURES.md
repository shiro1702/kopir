...
| ✅ done | WEB-13 | Partner кабинет | 4–5 | **bot** Sprint 4; **web** Sprint 5 / 04 |
...
| ✅ done | UX-04 | Количество копий | 2 | Sprint 5 / 07; бот 1–10, агент |
| ✅ done | UX-05 | Выбор точки: QR deep link | 1 | `?start=point_X` · Sprint 4 / 06 |
| ✅ done | UX-06 | Выбор точки: ручной номер / список / last point | 2 | Sprint 5 / 02 Phase A; код + список в боте |
...
| ✅ done | MON-09 | Ручная печать при сбое агента | 2 | файл staff + кнопка «Печать готова»; sprint-1/12; исходник также шлётся в staff сразу при PAID |
...
| Статус | ID | Фича | Этап | Примечание |
|--------|-----|------|------|------------|
| ✅ done | ONB-01 | Регистрация партнёра | 4–5 | **bot bind** Sprint 4; **web** Sprint 5 / 05 |
...
| ⏸ deferred | NIC-03 | МФЦ / госучреждения | 5 | web без TG; бланки → UX-16 |
