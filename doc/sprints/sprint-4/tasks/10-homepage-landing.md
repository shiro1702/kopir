...
| 7 | Точки печати | `#points` | Статический список пилота или `GET /api/points`; **полная карта** → Sprint 5 / [10](../../sprint-5/tasks/10-point-picker-site-mvp.md) |
...
- Полноценная карта Leaflet на главной → Sprint 5 / [10](../../sprint-5/tasks/10-point-picker-site-mvp.md) (спека: [point-picker-ux.md](../../../product/point-picker-ux.md))
