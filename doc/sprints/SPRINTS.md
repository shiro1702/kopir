...
Sprint 4  ◄──  АКТИВНЫЙ: ЛК партнёра в боте + баланс (PAY-06)
Sprint 5       Выплаты PAY-07 + web ЛК + 5 точек
Sprint 6       Рост
...
- Хвост Sprint 1 (UX-10, MON-02) — параллельно с Sprint 4, P1
...
**Не в Sprint 4:** web-регистрация, web ЛК, Mass Payments.
...
5+ точек, web ЛК v1, выплаты фаза 2–3, Windows Service, алерты, VK-бот.
...
**Цель:** партнёр управляет точкой через бот: статус, настройки, баланс. **Web ЛК — Sprint 5.**
