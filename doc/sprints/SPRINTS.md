...
**Активный спринт:** [Sprint 3 — Т-Банк (sandbox)](./sprint-3/README.md)  
**Предыдущий:** [Sprint 2 — Подготовка к коммерции](./sprint-2/README.md)  
...
## Sprint 3 — «Т-Банк» 🟡 sandbox

📁 [sprint-3/](./sprint-3/README.md)

**Цель:** онлайн-оплата СБП, автопечать без staff. **Sandbox:** DEMO-терминал; **prod:** после договора.

| Статус | Задача | Feature ID |
|--------|--------|------------|
| ✅ | Т-Банк: Init, GetQr, webhook | PAY-02, PAY-03 |
| ✅ | Провайдер + выбор в боте | PAY-02 |
| 🟡 | E2E: 10 платежей sandbox | — |
