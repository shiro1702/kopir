...
**Текущая дата:** 21 июля 2026  
**Активный спринт:** [Sprint 5 — «К 1 сентября»](./sprint-5/README.md)  
**Предыдущий:** [Sprint 4 — ЛК партнёра в боте](./sprint-4/README.md) ✅  
...
| P1 | «Ссылка точки»: QR + deep links TG/MAX + **универсальный /go** в `/admin/points` | ✅ |
...
| P1 | Блок выбора точки на сайте: карта + список + модалка ([10–12](./sprint-5/tasks/10-point-picker-site-mvp.md)) |
| P1 | Геолокация ближайшей точки (UX-07) |
| P2 | VK-бот, автопереключение offline |
...
| ⬜ | Карта точек + Mini App | WEB-10, WEB-07 | [03-point-map-miniapp.md](./sprint-5/tasks/03-point-map-miniapp.md) |
| ⬜ | Блок выбора точки на сайте (карта + список + модалка) | WEB-10 | [10-point-picker-site-mvp.md](./sprint-5/tasks/10-point-picker-site-mvp.md) |
| ⬜ | График и статус точки (открыто/закрыто) | WEB-10, MON-02 | [11-point-schedule-status.md](./sprint-5/tasks/11-point-schedule-status.md) |
| ⬜ | Геолокация, маршрут, фото входа | UX-07 | [12-point-geolocation-routes.md](./sprint-5/tasks/12-point-geolocation-routes.md) |
| ✅ | Hotfix: гонка при загрузке 5 файлов скопом | FILE-01, UX-15 | [13-batch-upload-race-hotfix.md](./sprint-5/tasks/13-batch-upload-race-hotfix.md) |
...
| ✅ | Web ЛК партнёра v1 | WEB-13 → [04-partner-web-lk.md](./sprint-5/tasks/04-partner-web-lk.md) |
| ✅ | Регистрация партнёра на сайте | ONB-01, ONB-02 → [05-partner-web-register.md](./sprint-5/tasks/05-partner-web-register.md) |
...
| ⬜ | Масштаб выбора точки: фильтры, поиск, кластеры | WEB-10, WEB-11 → [05-point-picker-scale.md](./sprint-6/tasks/05-point-picker-scale.md) |
| ⬜ | Админка контента точки: фото, услуги | WEB-12 → [06-point-admin-content.md](./sprint-6/tasks/06-point-admin-content.md) |
| ⬜ | 5+ новых копицентров | — |
