...
> **Последнее обновление:** 25.09.2026 · **UX-16** готовые бланки (spike)
...
| 5 | `✅ Оплатить` / finalize | ✅ | да · TG: reply + inline на карточке |
| 6 | `❌ Отменить всё` | ✅ | да · TG: reply + inline |
| 7 | `🗑 Удалить файл` | ✅ | да |
| 7b | `−` / `N копий` / `+` (1–10) | ✅ | нет |
| 7c | `/templates` + готовые бланки точки | 🔵 | нет · UX-16 spike |
...
| 13 | TG: кнопка «Открыть оплату» + «Проверить» | ✅ | prod (без answerCallbackQuery.url) |
